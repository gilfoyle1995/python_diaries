...
def get_story_string():
    """
    Returns: tupple with decrypted story with best shift value
    """
    f = open("story.txt", "r")
    story = str(f.read())
    f.close()
...
plaintext = PlaintextMessage(' Nonsense words: love hard latter determine usual fall meet shallow association expensive grow count scissors describe fair', 11)
print('Expected Output: jgnnq')
print('Actual Output:', plaintext.get_message_text_encrypted())
    
#Example test case (CiphertextMessage)
ciphertext = CiphertextMessage('Yzydpydp hzcod: wzgp slco wleepc opepcxtyp fdflw qlww xppe dslwwzh lddzntletzy piapydtgp rczh nzfye dntddzcd opdnctmp qltc')
